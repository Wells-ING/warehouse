...
public class SelectInOrderService {
    public static ArrayList<OrderPage> getOrdersByLikeAndCurrentManagerId(Integer currentManagerId, String keyWords) {
        ...
        for(Goods g : goods) {
            ArrayList<Order> orderArrayList = o.getOrderByGoodsSkuAndCurrentManagerId(currentManagerId, g.getGoodsSku());
