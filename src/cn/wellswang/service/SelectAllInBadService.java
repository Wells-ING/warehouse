...
public class SelectAllInBadService {
    public static ArrayList<BadPage> getAllBadPageResultByCurrentManagerId(Integer currentManagerId) {
        ...
        ArrayList<Bad> bads = b.getAllByCurrentManagerId(currentManagerId);
        for(Bad bad : bads) {
