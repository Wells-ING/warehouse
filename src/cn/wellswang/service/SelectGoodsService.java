...
public class SelectGoodsService {
    public static ArrayList<GoodsPage> getGoodsPageByLike(String keyWords) {
    ...
    public static ArrayList<Goods> getGoodsByLike(String keyWords) {
        GoodsInfoDAOImpl g = new GoodsInfoDAOImpl();

        return g.likeSelectGoods(keyWords);
    }
}
