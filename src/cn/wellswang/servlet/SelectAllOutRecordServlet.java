...
@WebServlet("/selectAllOutRecord")
public class SelectAllOutRecordServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 2. 查询符合条件的出库记录，并返回
        ArrayList<OutRecordPage> outRecordPages = OutRecordService.selectAllOutRecordByoutManagerLike(currentUserId);
        // 3. 将出库记录返回值前端
